...
export default function BotonMas(props) {
    let { fx }  = props
  return (
    <svg onClick={fx} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="40px" version="1.1" viewBox="0 0 700 700">
                              <g>
