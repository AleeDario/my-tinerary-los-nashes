               ...
               {mostrarEventoUno && (
                  myReactions.map((reaction, index) => {
                     ...
                     if (reaction.name === reaction.name) {
                        classReaction = `card ${reaction.name}`
                     } else {
                        classReaction = `card`
                     }
                     return (
                        <div key={index} className="flex justify-center m-t-3">
                           <div className={classReaction}>
                              <div className='card-body align-center flex column justify-around gap-2'>
                                 <img className='img-reaction' src={reaction.itineraryId.photo[0]} alt={reaction.itineraryId.name} />
                                 <h4>{reaction.itineraryId.name}</h4>
                                 <div className='flex justify-between w-100'>
                                    <h5 className='flex column align-center iconReaction'><img src={reaction.icon} alt="icon" width='30px' />{reaction.name}</h5>
                                    <img src="../img/trash.gif" alt="trash" name={reaction._id} width='40px' onClick={deleteReactionUser} />
                                 </div>
